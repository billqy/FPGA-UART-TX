...
## Switches
set_property PACKAGE_PIN V17 [get_ports input_signal]
...
## LEDs
set_property PACKAGE_PIN U16 [get_ports input_high]
	set_property IOSTANDARD LVCMOS33 [get_ports input_high]
